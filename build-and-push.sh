...
# Deploy Failure Page - Cross Platform Build and Push Script
# This script builds and pushes the deploy-failure-page Docker image for multiple architectures

set -e  # Exit on any error

# Configuration
IMAGE_NAME="hazelgallery/deploy-failure-page"
...
test_image() {
    ...
    TEST_CONTAINER=$(docker run -d -p 8999:80 \
        -e PORT=8999 \
        -e FAILURE_TEXT="# Build Test Success! ✅

## Multi-Platform Build Completed
- **AMD64**: ✅ Built successfully  
- **ARM64**: ✅ Built successfully  
- **Push**: ✅ Pushed to Docker Hub  
- **Test**: ✅ Container running  

> This is an automated test of the build script." \
        $IMAGE_NAME:latest)
    ...
    if docker ps | grep -q $TEST_CONTAINER; then
        ...
        print_status "Test URL: http://localhost:8999"
...
show_usage() {
    echo "Deploy Failure Page - Cross Platform Build Script"
    echo ""
...
main() {
    ...
    echo "========================================"
    echo "Deploy Failure Page - Multi-Platform Build"
    echo "========================================"
    echo ""
